export function Heroe(id, nombre, alias, editorial, fuerza, arma) {
  ...
  this.fuerza = fuerza;
  this.arma = arma;
  // empece haciendo el parcial y mas adelante vi que eran 2 clases que heredan y no me daba tiempo a cambiar
  // decidi seguir el parcial asi por que siono no iba terminar casi nada.
}
